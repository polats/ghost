...
---
Below are a collection of links with useful Unity3D VR-related source code and libraries. These are official example projects and SDKs from Oculus and Google and contain not only useful complete code examples but also articles on VR best practices. The Cardboard Design Lab example on the Google Daydream Unity SDK has good pointers on VR user interface.
